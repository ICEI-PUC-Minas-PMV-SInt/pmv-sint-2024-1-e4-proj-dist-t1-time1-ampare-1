...
const pages = [{ name: "ONG", link: "/cadastro-ong" }, { name: "Voluntário", link: "/cadastro-voluntario" }, { name: "Projeto", link: "/cadastro-projeto" }, { name: "Ajudar um Projeto", link: "/listagem-projetos" }];
      ...
      <Container maxWidth="xl">
        <Toolbar disableGutters>
          <Link style={{ textDecoration: "none", color: "white", display: "flex" }} to={"/"}>
            <Handshake sx={{ display: { xs: "none", md: "flex" }, mr: 1 }} />
            <Typography
              variant="h6"
              noWrap
              component="a"
          ...
          <Link style={{ textDecoration: "none", color: "white" }} to={Home} >
            <Handshake sx={{ display: { xs: "flex", md: "none" }, mr: 1 }} />
            <Typography
              variant="h5"
              noWrap
              component="a"
